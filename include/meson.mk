...
# .pc files generated by meson stored at libdata/pkgconfig instead of
# lib/pkgconfig, fix it by creating symlink.
ifeq ($(HOST_OS),FreeBSD)
$(shell mkdir -p "$(HOST_BUILD_PREFIX)/lib/pkgconfig" "$(HOST_BUILD_PREFIX)/libdata")
$(shell ln -sf "$(HOST_BUILD_PREFIX)/lib/pkgconfig" "$(HOST_BUILD_PREFIX)/libdata/pkgconfig")
endif
